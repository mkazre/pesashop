  ...
  return (
    <div className="border-2 border-blue-200 rounded-lg bg-blue-50 p-4 my-6">
      <div className="flex justify-between items-start mb-3">
        ...
        {save > 0 && <span className="bg-green-600 text-white text-xs px-2 py-1 rounded">Save {formatPrice(save)}</span>}
      </div>
      ...
      <div className="flex items-center justify-between border-t pt-3">
        <div>
          <p className="text-xs text-gray-500"><span className="line-through">{formatPrice(subtotal)}</span></p>
