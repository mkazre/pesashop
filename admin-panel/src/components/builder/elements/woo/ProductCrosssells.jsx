...
export const ProductCrosssells = (rawProps) => {
...
export const ProductCrosssellsSettings = ({ nodeId }) => {
...
ProductCrosssells.craft = {
  displayName: 'Product Cross-sells',
  props: { title: 'You may be interested in…', products: [{ name: 'Accessory Pack', price: '$14.99', image: 'https://placehold.co/200x200/e2e8f0/64748b?text=X1' }, { name: 'Carrying Case', price: '$24.99', image: 'https://placehold.co/200x200/e2e8f0/64748b?text=X2' }], columns: 4, gap: '16px', responsiveProps: {}, className: '', style: {},
    dynamicBindings: {},
  },
  rules: { canDrag: () => true, canMoveIn: () => false, canMoveOut: () => true },
  related: { settings: ProductCrosssellsSettings },
};
