...
export const ProductUpsells = (rawProps) => {
...
export const ProductUpsellsSettings = ({ nodeId }) => {
...
ProductUpsells.craft = {
  displayName: 'Product Upsells',
  props: { title: 'You may also like', products: [{ name: 'Premium Version', price: '$79.99', image: 'https://placehold.co/200x200/e2e8f0/64748b?text=Up1' }, { name: 'Deluxe Bundle', price: '$99.99', image: 'https://placehold.co/200x200/e2e8f0/64748b?text=Up2' }], columns: 4, gap: '16px', responsiveProps: {}, className: '', style: {},
    dynamicBindings: {},
  },
  rules: { canDrag: () => true, canMoveIn: () => false, canMoveOut: () => true },
  related: { settings: ProductUpsellsSettings },
};
