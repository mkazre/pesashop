...
const s = StyleSheet.create({
  ...
  itemRow: { flexDirection: "row", alignItems: "center", backgroundColor: colors.white, borderWidth: 1, borderColor: colors.gray200, borderRadius: 8, padding: 12, marginBottom: 8 },
  ...
  qtyBtn: { width: 26, height: 26, borderRadius: 13, backgroundColor: colors.gray100, alignItems: "center", justifyContent: "center" },
  ...
  chip: { paddingHorizontal: 12, paddingVertical: 8, borderRadius: 20, borderWidth: 1, borderColor: colors.gray200, backgroundColor: colors.white },
  chipActive: { backgroundColor: colors.primary, borderColor: colors.primary },
  chipText: { fontSize: 12, color: colors.gray700, fontWeight: "500" },
  chipTextActive: { color: colors.white },
  textArea: { borderWidth: 1, borderColor: colors.gray200, borderRadius: 8, padding: 12, fontSize: 13, color: colors.gray900, minHeight: 72, textAlignVertical: "top", backgroundColor: colors.white },
  uploadBox: { borderWidth: 2, borderColor: colors.gray200, borderStyle: "dashed", borderRadius: 8, padding: 16, alignItems: "center", backgroundColor: colors.white },
  uploadPlaceholder: { fontSize: 13, color: colors.gray500 },
  uploadFileText: { fontSize: 13, color: colors.gray700, fontWeight: "500" },
  radioRow: { flexDirection: "row", alignItems: "center", gap: 10, backgroundColor: colors.white, borderWidth: 1, borderColor: colors.gray200, borderRadius: 8, padding: 12 },
  radioLabel: { fontSize: 13, color: colors.gray800, flex: 1 },
  submitBtn: { backgroundColor: colors.primary, borderRadius: 8, paddingVertical: 15, alignItems: "center", marginTop: 24 },
