...
const s = StyleSheet.create({
  ...
  emptyBtn: { marginTop: 16, backgroundColor: colors.primary, paddingHorizontal: 24, paddingVertical: 12, borderRadius: 0 },
  ...
  disputeInput: { borderWidth: 1, borderColor: colors.gray200, borderRadius: 0, padding: 10, fontSize: 13, color: colors.gray900, minHeight: 64, textAlignVertical: "top" },
  disputeSubmitBtn: { backgroundColor: colors.primary, paddingHorizontal: 16, paddingVertical: 10, borderRadius: 0 },
