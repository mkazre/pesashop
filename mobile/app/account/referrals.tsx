...
const s = StyleSheet.create({
  ...
  copyBtn: { backgroundColor: colors.white, paddingHorizontal: 14, paddingVertical: 10, borderRadius: 0 },
  copyBtnText: { color: colors.primary, fontWeight: "700", fontSize: 12 },
  waBtn: { flexDirection: "row", alignItems: "center", gap: 6, backgroundColor: "#25D366", paddingHorizontal: 14, paddingVertical: 10, borderRadius: 0 },
  ...
  inviteInput: { flex: 1, borderWidth: 1, borderColor: colors.gray200, borderRadius: 0, paddingHorizontal: 12, paddingVertical: 10, fontSize: 13, color: colors.gray900 },
  sendBtn: { backgroundColor: colors.primary, paddingHorizontal: 18, borderRadius: 0, alignItems: "center", justifyContent: "center" },
